...
B = 2; % section length
R = 0.4; % design rate
channel = 'bec'; % awgnc | bec | bsc
noiseParam = 0.1; % snr for awgnc, epsilon for bec or bsc
firstE = 2^-15.4; % the first E value (MSE value) for which the potential will be calculated
