...
decoderInstances = 5; % the results will be averaged over this-many runs, 0 to disable decoder (it may be problematic to have large number of instances for BEC and BSC, as they occasionally fail due to NaNs, Infs, etc.)
...
stateEvolutionInstances = 5; % the results will be averaged over this many runs, 0 to disable state evolution (it may be problematic to have large number of instances for BEC and BSC, as they occasionally fail due to NaNs, Infs, etc.)
stateEvolutionShowPlot = true; % true for showing, false for no plot
monteCarloIterationCount = 10000;  % The number of Monte Carlo iterations
