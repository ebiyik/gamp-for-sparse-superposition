% GAMP algorithm for random matrices, stores the results of all iterations
...
for t=1:n
    ...
    %% input linear step
    Tr = max(1./(Ts'*(A.^2))', 1e-100); % min value is set due to the numerical problems of BEC and BSC
    rhat = xhat(:,t) + Tr.*(shat'*A)';
